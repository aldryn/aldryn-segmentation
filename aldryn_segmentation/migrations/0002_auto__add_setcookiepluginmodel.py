...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SetCookiePluginModel'
        db.create_table(u'aldryn_segmentation_setcookiepluginmodel', (
            ...
            ('days_to_expire', self.gf('django.db.models.fields.SmallIntegerField')(default=365)),
            ('path', self.gf('django.db.models.fields.CharField')(default='/', max_length=255, blank=True)),
        ))
        db.send_create_signal('aldryn_segmentation', ['SetCookiePluginModel'])


    def backwards(self, orm):
        # Deleting model 'SetCookiePluginModel'
        db.delete_table(u'aldryn_segmentation_setcookiepluginmodel')
    ...
    models = {
        ...
        'aldryn_segmentation.setcookiepluginmodel': {
            'Meta': {'object_name': 'SetCookiePluginModel', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'days_to_expire': ('django.db.models.fields.SmallIntegerField', [], {'default': '365'}),
            ...
            'path': ('django.db.models.fields.CharField', [], {'default': "'/'", 'max_length': '255', 'blank': 'True'}),
