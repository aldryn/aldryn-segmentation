...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CookieSegmentPluginModel.label'
        db.add_column(u'aldryn_segmentation_cookiesegmentpluginmodel', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CookieSegmentPluginModel.label'
        db.delete_column(u'aldryn_segmentation_cookiesegmentpluginmodel', 'label')
